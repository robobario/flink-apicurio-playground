...
public class SimpleAvroExample {
    ...
    private static final String REGISTRY_URL = "http://apicurio:8080/apis/registry/v2";
    private static final String SERVERS = "kafka:9092";
    private static final String TOPIC_NAME = "Example4";
